...
def test_stack_order_reverse(cli_runner, get_config):
    ...
    original_cwd = os.getcwd()
    os.chdir(tmpdir)
    regex = re.compile(generate_stack_regex(['ReverseOrder1\.TestStack2', 'ReverseOrder1\.TestStack1']), flags=re.DOTALL)
    try:
...
def test_stage_order_reverse(cli_runner, get_config):
    ...
    original_cwd = os.getcwd()
    os.chdir(tmpdir)
    regex = re.compile(generate_stack_regex(['ReverseOrder2\.TestStack1', 'ReverseOrder1\.TestStack1']), flags=re.DOTALL)
    try:
...
def test_stage_and_stack_order(cli_runner, get_config):
    ...
    original_cwd = os.getcwd()
    os.chdir(tmpdir)
    regex = re.compile(generate_stack_regex(['NormalOrder1\.TestStack1', 'NormalOrder1\.TestStack2', 'NormalOrder2\.TestStack1', 'NormalOrder2\.TestStack2']), flags=re.DOTALL)
    try:
...
def test_stage_and_stack_order_reverse(cli_runner, get_config):
    ...
    original_cwd = os.getcwd()
    os.chdir(tmpdir)
    regex = re.compile(generate_stack_regex(['ReverseOrder2\.TestStack2', 'ReverseOrder2\.TestStack1', 'ReverseOrder1\.TestStack2', 'ReverseOrder1\.TestStack1']), flags=re.DOTALL)
    try:
